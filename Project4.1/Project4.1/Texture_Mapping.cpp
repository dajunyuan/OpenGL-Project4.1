...
#include "include/Mesh_Painter.h"

#pragma comment(lib, "glew32.lib")
#pragma comment(lib, "freeimage/x32/FreeImage.lib")
...
glewExperimental = GL_TRUE;
	...
	my_mesh1->set_theta_step(0.1, 0.1, 0.1);//旋转速度
	...
	my_meshs.push_back(my_mesh1);
 	...
 	my_mesh2->set_theta_step(0.1, 0.1, 0.1);
 	...
 	my_mesh3->set_theta_step(0.1, 0.1, 0.1);
